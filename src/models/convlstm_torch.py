...
Implementation source:
        https://github.com/florianboergel/runoff_prediction/tree/v1
Paper:
    From weather data to river runoff: using spatiotemporal convolutional networks for discharge forecasting
    
    Florian Börgel, Sven Karsten, Karoline Rummel, and Ulf Gräwe
    Leibniz Institute for Baltic Sea Research Warnemünde, Rostock, Germany


'''

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_convLSTM.ipynb.

# %% auto 0
__all__ = ['ConvLSTMCell', 'ConvLSTM']

# %% ../nbs/01_convLSTM.ipynb 4
